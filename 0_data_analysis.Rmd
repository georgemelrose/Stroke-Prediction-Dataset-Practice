...
explanatory <- c("bmi_category","gender","hypertension_yn","ever_married")
dependent <- "stroke_yn"
...
explanatory <- c("bmi_category","work_type","residence_type","smoking_status")
dependent <- "stroke_yn"
...
explanatory <- c("bmi_category","heart_disease_yn","age_category")
dependent <- "stroke_yn"
...
* In those patients with heart disease and older patients (>60), there is also more BMI missingness. 
