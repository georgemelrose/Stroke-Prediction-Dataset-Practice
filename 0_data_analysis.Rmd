...
# K = 5 (default nearest neighbors), dup_size = 70% increase in stroke cases
balanced_data <- SMOTE(X, target, K = 5, dup_size = 5)

# Check the distribution of the balanced dataset
table(balanced_data$target)

# View the balanced dataset
head(balanced_data$data)
```
