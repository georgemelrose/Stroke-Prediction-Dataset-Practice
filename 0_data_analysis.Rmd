...
```{r}
# Add 'Unknown' as a factor level tok work_type to make it suitable for SMOTE#
...
stroke_data_balanced <- SMOTE(stroke_yn ~ ., data = stroke_data, 
                              perc.over = 70,perc.under = 165)

# Check new class distribution
table(stroke_data_balanced$stroke_yn)
prop.table(table(stroke_data_balanced$stroke_yn))  # Proportions
```
