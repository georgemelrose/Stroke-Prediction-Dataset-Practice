...
pacman::p_load(tidyverse,icd,knitr,kableExtra,finalfit,lubridate,data.table,
               ...
               scales,RColorBrewer,GGally,randomForest, caret,DT, gtsummary,cardx,ggsurvfit,mice)
...
explanatory <- c("bmi","gender","hypertension","heart_disease",
...
#explanatory <- "bmi"
explanatory <- c("bmi_category","gender","hypertension","heart_disease",
                 "ever_married","work_type","residence_type")
dependent <- "stroke_yn"
...
There is more missingness for the BMI variable in those patients who have stroke than those who do not. There is also slightly more missingness in males and those who have ever married, looking at the second row of the above output. From this plot, we can start to conclude that the BMI variable missigness is MAR - *missingness in a particular variable has an association with one or more other variables in the dataset*.
