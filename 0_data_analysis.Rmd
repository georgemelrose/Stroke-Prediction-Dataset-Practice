...
```{r}
# Identify the newly generated stroke cases that aren't in the original dataset
new_stroke_cases <- anti_join(balanced_data, stroke_data, by = "id")

# Append these new stroke cases to the original dataset
stroke_data_updated <- bind_rows(stroke_data, new_stroke_cases)

# Verify the new distribution of stroke_yn
