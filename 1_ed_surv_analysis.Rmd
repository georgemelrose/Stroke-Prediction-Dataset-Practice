...
stroke_data$age_category <- factor(stroke_data$age_category , levels = c("<60", "60-69", "70-79", ">80"))

levels(stroke_data$age_category)
...
stroke_data$bmi_category <- factor(stroke_data$bmi_category) 
...
-   A good concordance/C-statistic. This indicates how well the model
    predicts the order of events. A value of 0.768 means that in 76.8%
...
-   With 246 events out of 4253 individuals, the model has a moderate
    number of events to estimate the relationships. The concordance SE
    of 0.017 shows a relatively tight estimate of the concordance,
